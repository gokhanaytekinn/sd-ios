            ...
            VStack(spacing: 0) {
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        .onChange(of: email) { _, _ in self.authViewModel.clearEmailError() }
            ...
            VStack(spacing: 0) {
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        .onChange(of: newPassword) { _, _ in self.authViewModel.clearPasswordError() }
                        ...
                        .onChange(of: confirmPassword) { _, _ in self.authViewModel.clearConfirmPasswordError() }
